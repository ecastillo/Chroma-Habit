...
class test: UIViewController, JTAppleCalendarViewDelegate, JTAppleCalendarViewDataSource {
    ...
    func calendar(_ calendar: JTAppleCalendarView, cellForItemAt date: Date, cellState: CellState, indexPath: IndexPath) -> JTAppleCell {
        let customCell = calendar.dequeueReusableJTAppleCell(withReuseIdentifier: "customCell", for: indexPath) as! CustomCell2
        return customCell
    }
